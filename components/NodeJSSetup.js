          ...
          <div className="space-y-8">
            ...
            <div>
              ...
              <div className="bg-gray-900 text-green-400 p-4 rounded-lg font-mono text-sm overflow-x-auto mt-4">
                ...
                <div className="mt-2">node --version</div>
                <div className="mt-2"># Check NPM version</div>
            ...
            <div>
              ...
              <div className="bg-gray-900 text-green-400 p-4 rounded-lg font-mono text-sm overflow-x-auto mt-3">
                ...
                <div className="mt-2">npm install -g lodash</div>
                <div className="mt-2">
                  # Or install locally in a project
                </div>
                <div className="mt-2">mkdir my-project</div>
                <div className="mt-2">cd my-project</div>
                <div className="mt-2">npm init -y</div>
                <div className="mt-2">npm install lodash</div>
              </div>
            </div>
          </div>
        </div>
          ...
          <div className="space-y-4">
            <div className="border-2 p-4 border-blue-300 rounded-lg">
              ...
              <div className="space-y-3">
                ...
                <div className="bg-gray-900 text-green-400 p-4 rounded-lg font-mono text-sm overflow-x-auto">
                  ...
                  <div className="mt-2">winget install Schnizl.nvm</div>
                  <div className="mt-2"># Or download from GitHub</div>
                  <div className="mt-2">
                    # Restart terminal after installation
                  </div>
                  <div className="mt-2">nvm --version</div>
                  <div className="mt-2"># Install latest LTS</div>
                  <div className="mt-2">nvm install lts</div>
                  <div className="mt-2"># Use the installed version</div>
                  <div className="mt-2">nvm use lts</div>
                </div>
              </div>
            </div>
            ...
            <div className="border-2 p-4 border-blue-300 rounded-lg">
              ...
              <div className="bg-gray-900 text-green-400 p-4 rounded-lg font-mono text-sm overflow-x-auto">
                ...
                <div className="mt-2"># Install Node.js</div>
                <div className="mt-2">choco install nodejs-lts</div>
              </div>
            </div>
          </div>
        </div>
