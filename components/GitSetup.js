  ...
  return (
    ...
    >
      <div className="flex items-center mb-4 sm:mb-6 lg:mb-8 xl:mb-10">
        <div className="w-10 h-10 sm:w-12 sm:h-12 lg:w-14 lg:h-14 xl:w-16 xl:h-16 bg-orange-100 rounded-lg flex items-center justify-center mr-3 sm:mr-4 lg:mr-5 xl:mr-6 flex-shrink-0">
