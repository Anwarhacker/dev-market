    ...
    <div>
      ...
      <div className="min-h-screen lg:flex bg-gray-50 py-16 lg:py-30">
        ...
        <motion.section
          ...
          className="bg-white shadow-lg rounded-xl p-6 md:p-8 border border-green-700"
        >
          ...
          <div className="space-y-6">
            ...
            <div>
              ...
              <div className="bg-gray-900 text-green-400 p-4 rounded-lg font-mono text-sm overflow-x-auto">
                ...
                <div className="mt-2">MONGODB_URI=your_production_db_url</div>
                ...
                <div className="border-2 p-4 border-blue-300 rounded-lg">
                  ...
                  <ul className="space-y-1 text-sm text-gray-600">
                    ...
                    <li>
                      ...
                      - Export static files (with output: 'export' in
                      next.config.js)
                    </li>
                  </ul>
                </div>
